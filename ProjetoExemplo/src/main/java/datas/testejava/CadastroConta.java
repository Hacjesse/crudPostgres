...
public class CadastroConta extends javax.swing.JFrame {
    ...
    public CadastroConta(boolean editando, ContaCorrente conta) {
        initComponents();
        this.editando = editando;
        this.conta = conta;
        jTextFieldCodigo.setText(String.valueOf(conta.getCodigo()));
        if (editando){
            jTextFieldCodigo.setEditable(false);
        }
        
        jTextFieldNomeCliente.setText(conta.getNomeCliente());
        jTextFieldSaldo.setText(String.valueOf(conta.getSaldo()));
        jTextFieldLimite.setText(String.valueOf(conta.getLimite()));        
    }
